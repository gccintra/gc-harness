...
**CRITICAL - Respect the Architecture**: You MUST read `CLAUDE.md`. While this skill focuses on aesthetics, all design system choices (e.g., CSS modules vs Tailwind) and component libraries must follow the core project architecture.
